...
//  const isAccountsEnabled = null;
//  const isSubscriptionRequired = null;
//  const isAuthRequired = null;
...
//  const isComponentDisabled = showAuthenticationRequired || showSubscriptionRequired;
  ...
  const showAccountFeatures = null;
  const showAuthenticationRequired = null;
  const showSubscriptionRequired = null;
  const isComponentDisabled = null;
        ...
        >
          ...
          >
            ...
            <h4 className="font-light text-palette-600 text-lg mt-2 text-center">
              {mode === "file" && <span>Add or drop your files here to pin to S5 Network</span>}
              {mode === "directory" && <span>Drop any folder with an index.html file to deploy to S5 Network</span>}
            </h4>
          </div>
          {!isComponentDisabled && (
