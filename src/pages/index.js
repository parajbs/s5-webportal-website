        ...
        <div className="text-center">
          ...
          <p className="mt-5 font-light text-lg leading-7 text-palette-300">
            <span className="hidden desktop:block">
              S5 is a hosting platform that makes it easy to join the decentralized
            </span>
            ...
            <span className="desktop:hidden text-justify text-sm">
              S5 is a hosting platform that makes it easy to join the decentralized internet movement. Create your
              account today.
            </span>
          </p>
        </div>
